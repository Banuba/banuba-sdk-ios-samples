...
void main()
{
    ...
    var_v = (bnb_MV*vec4(vpos,1.)).xyz;
        ...
        lights[0] = vec4((bnb_MV*vec4(js_lights_pos0.xyz,1.)).xyz - var_v, 0.);
        lights[1] = vec4((bnb_MV*vec4(js_lights_pos1.xyz,1.)).xyz - var_v, 0.);
        lights[2] = vec4((bnb_MV*vec4(js_lights_pos2.xyz,1.)).xyz - var_v, 0.);
        lights[3] = vec4((bnb_MV*vec4(js_lights_pos3.xyz,1.)).xyz - var_v, 0.);


        radiance[0] = js_lights_radiance0.xyz;
        radiance[1] = js_lights_radiance1.xyz;
        radiance[2] = js_lights_radiance2.xyz;
        radiance[3] = js_lights_radiance3.xyz;
